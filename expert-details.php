      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="main-image">
            <img src="assets1/images/single-property.jpg" alt="">
          </div>
        ...
        <div class="col-lg-4">
          <div class="info-table">
            <ul>
              <li>
                <img src="assets1/images/info-icon-01.png" alt="" style="max-width: 52px;">
                <h4>450 m2<br><span>Total Flat Space</span></h4>
              </li>
              <li>
                <img src="assets1/images/info-icon-02.png" alt="" style="max-width: 52px;">
                <h4>Contract<br><span>Contract Ready</span></h4>
              </li>
              <li>
                <img src="assets1/images/info-icon-03.png" alt="" style="max-width: 52px;">
                <h4>Payment<br><span>Payment Process</span></h4>
              </li>
              <li>
                <img src="assets1/images/info-icon-04.png" alt="" style="max-width: 52px;">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="assets1/images/deal-01.jpg" alt="">
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="assets1/images/deal-02.jpg" alt="">
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="assets1/images/deal-03.jpg" alt="">
                    </div>
                    <div class="col-lg-3">
